...
def next_batch(batch_size, data, label, end_to_end,input_dimension_size,num_step, Trainable):
    ...
    for i in range(batch_len):
        ...
        yield (batch_input.reshape(num_step, -1, input_dimension_size), batch_prediction_target.reshape(-1, num_step - 1, input_dimension_size), mask.reshape(-1, num_step - 1, input_dimension_size), batch_label, batch_size, batch_need_label)
    ...
    if left_row != 0:
        ...
        yield (batch_input.reshape(num_step, -1, input_dimension_size), batch_prediction_target.reshape(-1, num_step - 1, input_dimension_size), mask.reshape(-1, num_step - 1, input_dimension_size), batch_label, left_row, batch_need_label)
